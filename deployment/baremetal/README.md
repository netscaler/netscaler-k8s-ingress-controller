...
1. Deploy the Netscaler ingress controller using the `kubectl create` command.
    ...
    The official Netscaler ingress controller docker image is available at: <span style="color:red"> `quay.io/netscaler/netscaler-k8s-ingress-controller:3.3.2` </span>
