...
```
docker pull quay.io/netscaler/netscaler-cpx:14.1-47.48 
```
...
```
docker run -dt -P --privileged=true -e EULA=yes --ulimit core=-1 --name cpx-hello-world quay.io/netscaler/netscaler-cpx:14.1-47.48 
```
...
00d58f020a9e        quay.io/netscaler/netscaler-cpx:14.1-47.48   "/var/netscaler/bi..."   5 seconds ago       Up 3 seconds        0.0.0.0:33122->22/tcp, 0.0.0.0:32770->161/udp, 0.0.0.0:33121->9080/tcp, 0.0.0.0:33120->9443/tcp   cpx-hello-world
```
