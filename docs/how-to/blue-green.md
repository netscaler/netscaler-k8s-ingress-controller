...
![deployment_configs](../media/deployment-configs.png)
...
![pipeline_configs](../media/pipeline-configs.png)
...
1. Update Citrix ADC configurations in `adc_configs/provider.tf`.
...
1. Update the `setup_config.json` file with version and traffic weight percentage.
       ...
       {
        "TRAFFIC_WEIGHT": "100",
        "ADC_CONFIG": "ci_cd/deployment_config/v1.conf",
...
1. Deploy the version v2 of the application by updating `setup_config.json`.
        ...
        {
        "TRAFFIC_WEIGHT": "0",
        "ADC_CONFIG": "ci_cd/deployment_config/v2.conf",
