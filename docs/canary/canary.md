...
-  Netscaler ingress controller build/version: `quay.io/netscaler/netscaler-k8s-ingress-controller:4.1.17`.
-  Netscaler CPX version: `quay.io/netscaler/netscaler-cpx:14.1-66.59`.
