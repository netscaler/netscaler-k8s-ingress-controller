...
> then you should add the label `citrix-adc: cpx` in all the services of your application which are pointing to the Netscaler CPX IP address after modifying the service.
