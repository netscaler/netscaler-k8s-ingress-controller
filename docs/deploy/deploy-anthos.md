...
- To use a Netscaler VPX or MPX from a different network, use [Citrix Node Controller](https://github.com/citrix/citrix-k8s-node-controller) to enable communication between the Netscaler and the Anthos GKE on-prem cluster.
...
7. Deploy the Citrix ingress controller as a Tier-1 ingress controller.
   ...
   2. Enter the management IP address of Netscaler. Update the Tier-1 Netscaler's management IP address in the placeholder `Tier-1-Citrix-ADC-IP` specified in the `cic.yaml` file.
...
- To use a Netscaler VPX or MPX from a different network, use the [Citrix Node Controller](https://github.com/citrix/citrix-k8s-node-controller) to enable communication between the Netscaler and the Anthos GKE on-prem cluster.
