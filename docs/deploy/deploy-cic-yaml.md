...
- For Citrix ADC CPX 13.0.64.35 and later versions, use the following YAML:
  ...
  [cpx-ingress-latest.yml](https://github.com/citrix/citrix-k8s-ingress-controller/blob/master/deployment/baremetal/yaml-cpx-crediential-changes/cpx-cic-latest.yaml)
